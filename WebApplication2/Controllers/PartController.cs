...
namespace PTL.Controllers
{
    public class PartController : Controller
    {
        ...
        [HttpPost]
        public List<PutToLight> getParts()
        {
            string sql = "PartNumberQuantityControll";
            List<PutToLight> result = new List<PutToLight>();
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
                connection.Execute(sql, commandType: CommandType.StoredProcedure);
                result = connection.QueryAsync<PutToLight>(sql, commandType: CommandType.StoredProcedure).Result.ToList();
                return result;
            }
        }
